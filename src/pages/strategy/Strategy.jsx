...
function Strategy() {
  ...
  <div className="u-clearfix u-sheet u-sheet-1">
    ...
    <p  data-aos="fade-up" className="u-text u-text-default u-text-19"> Siddiq Ahmad Khan is a brand strategist at&nbsp;<span className="boldtextlink"> <b> Business GO Digital </b></span>&nbsp;and was involved in the national campaign of branding of the wine industry and service firms in Southern Europe, hospitality and construction sectors in the Middle East served as Assistant Professor at business school in the largest private university in Pakistan in the marketing specialization area, consulted in establishing associations, clubs, and businesses. He has been speaking to different peer groups as well.&nbsp;<span className="boldtextlink"> <b> SPANTIK </b></span>&nbsp;is a brand-building model to contribute practitioner and top-level management in their strategic branding process of corporations and products. It consists of seven phases practically connected and a guide for markets and brand builders.
    </p>
