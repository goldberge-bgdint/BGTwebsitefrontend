  ...
  return (
    <div>
        ...
        <div className='blendedslider text-center '>
                <h5 data-aos="fade-up" > BRAND PROMOTION </h5>
                <div className="blendedsliderdivider"></div>
                <span  data-aos="fade-up" className='blendedsliderlink' > You are here: <a href="/home">  <Link to="/home" >home</Link> </a> {`>>`} BRAND PROMOTION </span>
        </div>   
  ...
  <div className="u-clearfix u-sheet u-sheet-1">
        ...
        <div className="u-layout-row">
          <div  data-aos="fade-right" className="u-container-style u-layout-cell u-size-42 u-layout-cell-1">
            <div className="u-container-layout u-valign-top u-container-layout-1">
              <h3 style={{color:"var(--primary)"}} className="u-text u-text-default u-text-1"> Promoting Product or Brand?</h3>
        ...
        <div className="u-layout-row">
          <div  data-aos="fade-right" className="u-container-style u-layout-cell u-size-23 u-layout-cell-3">
            <div className="u-container-layout u-container-layout-3">
              <h4 style={{color:"var(--primary)"}}  className="u-text u-text-default u-text-3"> Brand Promotion</h4>
          ...
          <div  data-aos="fade-left" className="u-container-style u-layout-cell u-size-23 u-layout-cell-5">
            <div className="u-container-layout u-container-layout-5">
              <h4 style={{color:"var(--primary)"}}  className="u-text u-text-default u-text-5"> How to attract customers?</h4>
    ...
    <div className="row">
      ...
      <div data-aos="fade-left" className="col-lg-6">
        <img src="images/princess-om-horse-2048x2048.jpg" className="leftimage" alt="" />
      </div>

      <div data-aos="fade-right" className="col-lg-6 mt-2 ">

        <div className="row mt-lg-0 mt-2 ">

          <div className="col-md-6 mt-md-0 mt-4 ">
          <img src="images/PrincessZ-19.png"  className="rightimage" alt="" />
          </div>

          <div className="col-md-6 mt-md-0 mt-4 ">
          <img src="images/image_2022_10_06T11_24_50_297Z.png" className="rightimage"  alt="" />
          </div>
        ...
        <div className="row mt-2 ">
          ...
          <div className="col-md-6 mt-md-0 mt-4 ">
          <img src="images/image_2022_10_06T11_24_21_446Z.png" className="rightimage"  alt="" />
          </div>

          <div className="col-md-6 mt-md-0 mt-4 ">
          <img src="images/image_2022_10_06T11_17_36_702Z.png" className="rightimage"  alt="" />
          </div>
